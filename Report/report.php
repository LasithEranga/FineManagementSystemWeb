...
<div class="d-flex flex-column bg-dark text-white col-lg-12 h-auto" style="min-height: 100vh;">
  ...
  <!--date picker-->
  <div class="d-flex ps-4 col-12">

    <div class="d-flex flex-row ps-4 ps-lg-2 col-lg-4">
      <div class=" d-flex flex-column flex-md-row mb-5 pb-5">
        <label for="from">From:</label>
        <input type="date" class=" ms-2 me-2" id="from" name="from">

        <label for="to">To:</label>
        <input type="date"  class=" ms-2" id="to" name="to">
      </div>
    </div>

    <div class="d-flex flex-row ps-4 col-lg-7">
      <div class=" d-flex flex-column col-lg-2">
        <button type="button" class="btn btn-success px-3 ms-2 mt-4 mt-lg-0">Go</button>
      </div>

      <div class=" d-flex flex-column bg-white col-lg-5 ">
        <button type="button" class="btn btn-success px-3 mt-4 ms-1 mt-lg-0 col-6  ">Share</button>
        <button type="button" class="btn btn-success px-1 mt-2 ms-1 col-6">Save as PDF</button>
      </div>
    </div>
