...
<body>
    <div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="input-group mb-3">
                            <input id="nic_no" type="text" class="form-control" placeholder="9904856484V" aria-label="Username" aria-describedby="basic-addon1">

                        </div>
                        <p id="NIC_not_given_error" class="text-danger"></p>
                    </div>
        ...
        <button type="button" id="nic_modal" class="btn btn-primary" hidden="true" data-bs-toggle="modal" data-bs-target="#nic_input">
        </button>
    </div>
    ...
    <nav class="navbar navbar-dark bg-dark sticky-top">
        <div class="container-fluid">
            <div class="input-group flex-nowrap">
                ...
                <input id="search_input" type="text" class="form-control col-2" placeholder="Search Rules..." aria-label="Username" aria-describedby="addon-wrapping" onkeypress="suggestRule(this.value)">
    ...
    <script>
        ...
        var totalAmount = 0;
        var NIC_not_given_error = document.getElementById('NIC_not_given_error');
        ...
        function verifyNIC(nic) {
            if (nic.length > 0) {
                NIC_not_given_error.innerHTML = ""; //removing error if user has entered nic
                ...
                NIC_not_given_error.innerHTML = "NIC is required!";
            }
        }
        ...
        function setStatementID() {
            ...
            xmlhttp.onload = function() {
                ...
                issue_time.innerHTML = currentdate.toLocaleString('en-US', {
                    hour: 'numeric',
                    minute: 'numeric',
                    hour12: false
                });
        ...
        function saveFineReceipt() {
            if (ruleList.length == 0) {
                alert('Add one or more rules to proceed!');
            } else {
                const xmlhttp = new XMLHttpRequest();
                xmlhttp.onload = function() {
                    if (this.responseText) {
