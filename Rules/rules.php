     ...
     <div class="modal-dialog  modal-dialog-centered">
         <div class="modal-content bg-dark text-light">
             ...
             <div class="modal-body ">
                 <form id="modal_items" action="Rules/save_update_rule.php" method="GET">
 ...
 <script>
     ...
     function fillTable() {
         ...
         http_req.open('GET', "Rules/get_rule_details.php");
         http_req.send();
     }
     fillTable();
     ...
     function showUpdateModal(rule_id) {
         ...
         http_req.open('GET', "Rules/rule_modal_details.php?rule_id=" + rule_id);
         http_req.send();
     }
